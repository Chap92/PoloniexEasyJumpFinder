...
allCoins = ['BTC_XMR', 'BTC_ETH', 'BTC_FCT', 'BTC_BURST', 'BTC_LSK', 'BTC_ETC', 'BTC_SJCX', 'BTC_DASH', 'BTC_DGB', 'BTC_MAID', 'BTC_NAV', 'BTC_BTS', 'BTC_AMP', 'BTC_XRP', 'BTC_VTC', 'BTC_EXP', 'BTC_STEEM', 'BTC_BCY', 'BTC_XCP', 'BTC_NXT', 'BTC_CLAM', 'BTC_LBC', 'BTC_LTC', 'BTC_GRC', 'BTC_FLDC', 'BTC_HUC', 'BTC_SC', 'BTC_OMNI', 'BTC_NAUT', 'BTC_GAME', 'BTC_SYS', 'BTC_STR', 'BTC_XEM', 'BTC_XVC', 'BTC_BLK', 'BTC_FLO', 'BTC_SBD', 'BTC_RADS', 'BTC_DOGE', 'BTC_ARDR', 'BTC_DCR', 'BTC_NEOS', 'BTC_EMC2', 'BTC_BCN', 'BTC_BELA', 'BTC_PPC', 'BTC_NOTE', 'BTC_VIA', 'BTC_VRC', 'BTC_XPM', 'BTC_BTCD', 'BTC_XBC', 'BTC_POT', 'BTC_RIC', 'BTC_NMC', 'BTC_BTM']
minPcentChnge = -0.01
minBTCVol = 1
